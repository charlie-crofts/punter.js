...
The repo includes a few games in `games`. To try these examples using:
...
3. **go** - call `punter.go()` to start. If assets are still loading, the engine waits and starts automatically
